...
if __name__=="__main__":
    ...
    default_image_name = '{}-corrflow-image'.format(user_name)
    ...
    parser.add_argument("-c", "--container", type=str, default="corrflow-container-{}".format(user_name), help="(optional) name of the container")\
